define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'stat_total_day/index' + location.search,
                    add_url: 'stat_total_day/add',
                    edit_url: 'stat_total_day/edit',
                    del_url: 'stat_total_day/del',
                    multi_url: 'stat_total_day/multi',
                    table: 'stat_total_day',
                }
            });
