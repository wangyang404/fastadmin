...
class Auth
{
    ...
    protected $_token = '';
    //Token默认有效时长
    protected $keeptime = 720000;
    protected $requestUri = '';
    protected $rules = [];
    //默认配置
    protected $config = [];
    protected $options = [];
    protected $allowFields = ['id', 'username', 'nickname', 'mobile', 'avatar', 'score','USER_TYPE'];
     ...
     * @return boolean
     */
    public function register($username, $password, $email = '', $mobile = '',$userType='', $extend = [])
    {
    ...
    public function direct($user_id)
    {
        ...
        if ($user) {
            ...
            try {
                ...
                //判断连续登录和最大连续登录
//                var_dump($user->logintime < \fast\Date::unixtime('day'));
