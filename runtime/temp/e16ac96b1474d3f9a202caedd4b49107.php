<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"D:\phpstudy_pro\WWW\FastAdmin\public/../application/admin\view\plan\add.html";i:1620716563;s:72:"D:\phpstudy_pro\WWW\FastAdmin\application\admin\view\layout\default.html";i:1555662057;s:69:"D:\phpstudy_pro\WWW\FastAdmin\application\admin\view\common\meta.html";i:1555662057;s:71:"D:\phpstudy_pro\WWW\FastAdmin\application\admin\view\common\script.html";i:1555662057;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-PLAN_NAME" class="form-control" name="row[PLAN_NAME]" type="text">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-PLAN_TYPE" class="form-control" name="row[PLAN_TYPE]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Cost_money'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-COST_MONEY" class="form-control" step="0.00000001" name="row[COST_MONEY]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Total_money'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-TOTAL_MONEY" class="form-control" step="0.00000001" name="row[TOTAL_MONEY]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Plan_price'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-PLAN_PRICE" class="form-control" step="0.00000001" name="row[PLAN_PRICE]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Custom_user_price'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-CUSTOM_USER_PRICE" class="form-control " rows="5" name="row[CUSTOM_USER_PRICE]" cols="50"></textarea>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-LIMIT_MONEY" class="form-control" step="0.00000001" name="row[LIMIT_MONEY]" type="number">
        </div>
    </div>
